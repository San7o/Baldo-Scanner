...
#ifndef _BALDO_KPROBE_H
#define _BALDO_KPROBE_H
...
/* Debug function */
/*
static void baldo_dump_registers(struct pt_regs *regs) {
    //dump_stack();
    printk(KERN_INFO "Baldo: ===== Registers =====\n");
    printk(KERN_INFO "Baldo: rax=0x%lx\n", regs->ax);
    printk(KERN_INFO "Baldo: rbx=0x%lx\n", regs->bx);
    printk(KERN_INFO "Baldo: rcx=0x%lx\n", regs->cx);
    printk(KERN_INFO "Baldo: rdx=0x%lx\n", regs->dx);
    printk(KERN_INFO "Baldo: rbp=0x%lx\n", regs->bp);
    printk(KERN_INFO "Baldo: rdi=0x%lx\n", regs->di);
    printk(KERN_INFO "Baldo: rsi=0x%lx\n", regs->si);
    printk(KERN_INFO "Baldo: r10=0x%lx\n", regs->r10);
    printk(KERN_INFO "Baldo: r8=0x%lx\n", regs->r8);
    printk(KERN_INFO "Baldo: r9=0x%lx\n", regs->r9);
    ...
    printk(KERN_INFO "Baldo: arg1=0x%lx\n", arg1);
    printk(KERN_INFO "Baldo: arg2=0x%lx\n", arg2);
    printk(KERN_INFO "Baldo: arg3=0x%lx\n", arg3);
    printk(KERN_INFO "Baldo: arg4=0x%lx\n", arg4);
}
*/

#endif // _BALDO_KPROBE_H
